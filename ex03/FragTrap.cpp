...
FragTrap::FragTrap(std::string name) : ClapTrap(name)
{
	...
	this->AttackDamage = 30;
	this->HitPoints = 100;
	std::cout << "Constructor for FR4G-TP " + this->getName() + " being called" << std::endl;
}
...
FragTrap::FragTrap(FragTrap const& to_copy)
{
	if (this != &to_copy)
		*this = to_copy;
	std::cout << "Copy constructor called on FR4G-TP " << this->getName() << std::endl;
}
FragTrap& FragTrap::operator=(FragTrap const& to_copy)
{
	...
	std::cout << "Assignation operator called on FR4G-TP " << this->getName() << std::endl;
	return (*this);
}
FragTrap::~FragTrap()
{
	std::cout << "FR4G-TP " + this->getName() + " is now out of business" << std::endl;
}
...
void FragTrap::takeDamage(unsigned int amount)
{
    ...
    std::cout << "FR4G-TP " + this->getName() + " lost " << hit_for << 
...
void FragTrap::beRepaired(unsigned int amount)
{
	...
	std::cout << "FR4G-TP " + this->getName() + " is getting repaired for " 
	<< amount <<  " hit points and has now (" << HP << ") HitPoint" << std::endl;
}

void FragTrap::highFivesGuys()
{
	std::cout << "FR4G-TP " + this->getName() + " is happy to give you five !" << std::endl; 
}
